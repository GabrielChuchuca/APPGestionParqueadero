...
a persistence unit "gestionparqueaderoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "gestionparqueadero\pom.xml":
...
artifact ("gestionparqueadero.war") is already built. You can build
